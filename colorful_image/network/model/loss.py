...
def weighted_categorical_crossentropy_wrapper(prior_probs, params):
    ...
    def weighted_categorical_crossentropy(y_true, y_pred):
        ...
        Note that the following code is based on the function categorical_crossentropy defined in keras/keras/backend/cntk_backend.py (see github: keras-team/keras).
        """
