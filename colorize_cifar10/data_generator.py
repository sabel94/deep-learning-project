...
#Get batches of training or validation samples.
def get_samples(datagen, images, shuffle):
    for batch in datagen.flow(images, batch_size=batch_size, shuffle=shuffle):
        #Convert to Lab color space, i.e. shape: (batch_size, height, width, 3).
        #Lab has 3 channels: grayscale (L), a and b.
